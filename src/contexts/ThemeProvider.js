...
const getThemeConfig = (mode) => ({
  palette: {
    mode,
    primary: {
      main: mode === 'light' ? "#1976d2" : "#90caf9", // Clinical blue
      light: mode === 'light' ? "#42a5f5" : "#bbdefb",
      dark: mode === 'light' ? "#1565c0" : "#42a5f5",
      contrastText: mode === 'light' ? "#ffffff" : "#000000",
    },
    secondary: {
      main: mode === 'light' ? "#90caf9" : "#f48fb1", // Light blue / Pink
      light: mode === 'light' ? "#bbdefb" : "#f8bbd9",
      dark: mode === 'light' ? "#42a5f5" : "#c2185b",
    },
    background: {
      default: mode === 'light' ? "#f5f7fa" : "#121212", // Soft white/grey vs Dark
  ...
  // Component overrides for better mobile experience
  components: {
    MuiButton: {
      styleOverrides: {
        root: {
