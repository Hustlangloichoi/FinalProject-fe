    ...
    >
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, mb: 3 }}>
        <Typography sx={{ mb: 2 }}>
          ...
          devices, please contact us using the information below.
        </Typography>
        <Stack spacing={2}>
          <Typography>
            <b>Facebook:</b>{" "}
            <a
              href="https://www.facebook.com/kun.nguyen.35"
              target="_blank"
          ...
          <Typography>
            <b>Email:</b>{" "}
            <a href="mailto:goodday.ltd.vn@gmail.com">
              goodday.ltd.vn@gmail.com
            </a>
          </Typography>
        </Stack>
      </Paper>
